...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WIFI_SCAN_INTERVAL_SEC, 60);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SERVO_SWAP_CHANNELS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SERVO_IDLE_PWM_OFF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SERVO_SETTLE_MS, 500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_DELAY, 6000);
