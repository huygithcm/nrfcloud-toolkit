...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_DEVICE_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_DEVICE_ID_FROM_HWID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_DEVICE_ID_PREFIX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_MQTT_TOPIC_PREFIX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_MQTT_DATA_TOPIC_SUFFIX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_HW_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_FW_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_DEVICE_TYPE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SCHEMA_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_HEARTBEAT_INTERVAL_SEC, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_NETWORK_INTERVAL_SEC, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_LOG_MQTT_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_GNSS_INTERVAL_SEC, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_HOSTNAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_PORT, 8883);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_USERNAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_PASSWORD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_TLS_SEC_TAG, 42);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_TLS_PEER_VERIFY, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_PUBLISH_LOCK_TIMEOUT_MS, 3000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_SOCKET_TIMEOUT_MS, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_TLS_PROVISION_CA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_CLIENT_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMQX_PUB_TOPIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_ESP32_BAUD, 115200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_ESP32_RX_BUF_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WIFI_MAX_APS, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WIFI_SCAN_INTERVAL_SEC, 300);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WIFI_RETRY_SEC, 15);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WIFI_RESP_TIMEOUT_SEC, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOCATION_SAMPLE_INTERVAL_SEC, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOCATION_WIFI_TIMEOUT_SEC, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SERVO_PWM_PERIOD_USEC, 20000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SERVO_MIN_PULSE_USEC, 600);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SERVO_MAX_PULSE_USEC, 2400);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SERVO_SEQ_OPEN_CLOSE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SERVO_SEQ_STEP_MS, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SERVO_MOVE_TIME_MS, 700);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_CMD_SERVO_TIMEOUT_SEC, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SERVO_IDLE_PWM_OFF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SERVO_SETTLE_MS, 700);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SERVO_MAX_HOLD_SEC, 15);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WATCHDOG_TIMEOUT_MS, 30000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WATCHDOG_FEED_INTERVAL_MS, 10000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WATCHDOG_STARTUP_GRACE_MS, 60000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WATCHDOG_MAIN_MAX_SILENCE_MS, 15000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WATCHDOG_TASK_MAX_SILENCE_MS, 30000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_WATCHDOG_LONG_OPERATION_MS, 180000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_CONFIG_NVS_SECTOR_COUNT, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MESSAGE_QUEUE_MAX_MSGS, 25);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_FAULT_STRERROR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_CONN_EVAL_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_MODE_PREFERENCE_LTE_M, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_MODE_PREFERENCE_VALUE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_3_ASYNC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_3_ENHANCED_POLL_OUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_3_NRF_TX_BUFFER_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_3_NRF_ASYNC_LOW_POWER, 1);
